...
<main class="z-0"> 
    ...
    >
        <div class="flex flex-col justify-center h-full text-white lg:max-w-[560px]">
            <h1 class="pb-2 text-[40px] lg:pb-6 lg:text-[72px] leading-[110%] gilda">Libera tu potencial con el crecimiento personal</h1> 
            <p class="text-lg lora-medium">Bienvenido a minuto de Acción, tu blog de referencia para obtener información e inspiración sobre desarrollo personal. Acompáñanos en un viaje para descubrir estrategias prácticas que te empoderarán para vivir al máximo.</p>
            <div class="pt-6">
                <a href="<?php echo esc_url($posts_page_url); ?>" class="bg-white w-full h-10 px-8 py-2.5 rounded-full text-[var(--olive)] hover:bg-[var(--olive)] hover:text-white transition-all duration-75 lora-medium">Explorar</a>
            </div>
        </div>
    </section>
    ...
    <section class="px-4 lg:px-20 pt-20 pb-16 bg-[var(--main-bg)]">
        <div class="max-w-[768px] mx-auto lg:mx-0">
            <h3 class="pb-12 lg:pb-20 text-[32px] lg:text-4xl font-semibold gilda">Desbloquee su potencial con nuestras estrategias y conocimientos de superación personal</h3>
        </div>
        ...
        <div class="flex flex-col lg:flex-row items-center justify-center lg:justify-between max-w-[1400px] gap-y-12">
            <div class="flex flex-col text-left gap-y-6 max-w-[400px] lg:h-[323px]">
                ...
                <h5 class="text-[28px] leading-[140%] gilda">Historias de éxito inspiradoras para motivar tu camino hacia la grandeza</h5>
                <p class="text-base lora">Explora consejos prácticos para mejorar su bienestar mental y su felicidad general.</p>
            </div>
            <div class="flex flex-col text-left gap-y-6 max-w-[400px] lg:h-[323px]">
                ...
                <h5 class="text-[28px] leading-[140%] gilda">Transforma tu vida con técnicas probadas para el crecimiento personal</h5>
                <p class="text-base lora">Descubra consejos prácticos que le ayudarán a alcanzar sus objetivos personales.</p>
            </div>
            <div class="flex flex-col text-left gap-y-6 max-w-[400px] lg:h-[323px]">
                ...
                <h5 class="text-[28px] leading-[140%] gilda">Cultivar una mentalidad positiva para un cambio y una realización duraderos</h5>
                <p class="text-base lora">Únase a nosotros para fomentar la resiliencia y una mentalidad orientada al crecimiento.</p>
    ...
    <section class="flex flex-col items-center justify-center px-4 lg:px-20">
        <div class="pt-16 pb-12 text-center font">
            ...
            <p class="leading-[160%] lora-semibold">
                Descubra consejos de crecimiento personal e historias inspiradoras.
            </p>
        </div>
                             ...
                             <div class="flex flex-col px-4 pt-6 text-left">
                                ...
                                <?php endif; ?>    
                                     ...
                                     <div class="flex items-center pb-10 pt-6 gap-x-2 hover:text-[var(--olive)] lora-medium">
                                         <a class="text-lg" href="<?php the_permalink() ?>">Leer el articulo</a>
        ...
        <div class="mt-12 mb-16 lg:mb-24">
            <a class="lora-medium leading-[160%] px-6 py-[10px] rounded-xl bg-[var(--main-bg)] hover:bg-white transition-all duration-100 border" href="/catergory/">Ver todo</a>
        </div>
    </section>
    ...
    <section class="bg-[var(--footer-cta-bg)] text-white px-5 lg:px-20 py-16 lg:py-[112px]">
            ...
            <div class="flex flex-col items-center justify-center text-center mx-auto max-w-[271px] md:max-w-[700px] lg:max-w-[100%] gap-y-5 p-8 lg:px-64 lg:py-20 border border-[var(--main-bg)] rounded-2xl">
              <h2 class="text-4xl lg:text-[52px]  gilda leading-[120%]  ">¡Únase a nuestra comunidad hoy!</h2> 
              <p class="lora leading-[160%] text-lg">Manténgase al día con nuestras últimas ideas y consejos para el crecimiento personal. ¡Suscríbase ahora!</p>

                <a href="/newsletter/" class="p-4 text-black bg-white rounded-xl">Suscríbete al boletín</a>
