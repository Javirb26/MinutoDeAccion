...
<main class="z-0"> 
    ...
    <section>
        <div>
            <h2> Un Minuto Puede <span>cambiar tu vida</span> </h2>
            <p>En un Minuto de Accion te damos ideas simples y motivacion diaria para que conviertas tus metas en pasos concretos.</p>
        </div>
        <div>
            <div>
                ...
                <p>Aprende a enfocarte en lo que realmente importa. Consejos prácticos para dejar la confusión atrás y avanzar con propósito.</p>
            </div>
            <div>
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
