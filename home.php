...
<main class="flex flex-col w-full mx-auto bg-slate-50">
    ...
    <section class="flex flex-col w-full px-5 py-16 transition-all duration-100 lg:py-28 lg:px-20 lg:max-w-[768px]">
        <p class="lora-semibold">Inspiración</p>
        <h1 class="text-5xl lg:text-7xl gilda leading-[120%] pt-3 lg:pt-4">Empodera tu viaje</h1>
        <!-- <p class="pb-3 italic text-md font-extralight gilda"><q>Cree en ti y haz que suceda en todas las cosas</q></p> -->
        <p class="pt-2 lg:pt-6 lora lg:text-lg leading-[160%]">Explora artículos sobre crecimiento personal, historias de éxito y consejos para mejorar su bienestar mental.</p>
    </section>
     ...
     <section class="flex flex-col justify-center bg-[var(--main-bg)] px-5">
        <div class="pt-16 pb-12 text-center lg:pb-20 lg:pt-28">
            ...
            <h2 class="gilda leading-[120%] text-4xl lg:text-[52px] pt-3 lg:pt-4">Últimos conocimientos y consejos</h2>
            <p class="lora lg:text-lg leading-[160%] pt-5 lg:pt-6">Explora nuestra colección de artículos de crecimiento personal.</p>
        </div>
         <div 
                             ...
                             <div class="flex flex-col w-full px-5 pt-2 mx-auto text-left gap-y-2">
                                ...
                                <?php endif; ?>    
                                     ...
                                     <div class="flex items-center pb-10 gap-x-2 hover:text-[var(--olive)]">
                                         <a class="text-lg underline lora" href="<?php the_permalink() ?>">Leer el articulo</a>
         ...
         <button @click="click = !click":class="click ? 'hidden' : 'block' " id="view-all" class="px-6 py-3 border border-[var(--footer-cta-bg)] rounded-xl bg-white hover:text-white hover:bg-[var(--footer-cta-bg)] transition-all mb-16 lg:mb-28 max-w-[115px] mx-auto">Ver todo</button>
     </section>
     <!-- FAQ Section -->
